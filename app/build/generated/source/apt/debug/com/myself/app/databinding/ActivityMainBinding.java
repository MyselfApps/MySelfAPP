package com.myself.app.databinding;
import com.myself.app.R;
import com.myself.app.BR;
...
public class ActivityMainBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    private com.myself.app.viewModel.MainViewModel mViewModel;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, Object variable) {
        switch(variableId) {
            case BR.viewModel :
                setViewModel((com.myself.app.viewModel.MainViewModel) variable);
                return true;
        }
        return false;
    }

    public void setViewModel(com.myself.app.viewModel.MainViewModel ViewModel) {
    ...
    public com.myself.app.viewModel.MainViewModel getViewModel() {
        return mViewModel;
    }
    ...
    protected void executeBindings() {
        ...
        java.lang.String viewModelH = null;
        com.myself.app.viewModel.MainViewModel viewModel = mViewModel;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            android.databinding.adapters.TextViewBindingAdapter.setText(this.tv, viewModelH);
        }
    }
    ...
    public static ActivityMainBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup root, boolean attachToRoot, android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityMainBinding>inflate(inflater, com.myself.app.R.layout.activity_main, root, attachToRoot, bindingComponent);
    }
    ...
    public static ActivityMainBinding inflate(android.view.LayoutInflater inflater, android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.myself.app.R.layout.activity_main, null, false), bindingComponent);
    }
